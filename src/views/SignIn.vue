...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-white-200 via-blue-200 to-white-200 p-4">
  
  <div class="w-full max-w-2xl backdrop-blur-xl bg-black/25 p-8 rounded-[2rem] shadow-2xl border border-white/20">
